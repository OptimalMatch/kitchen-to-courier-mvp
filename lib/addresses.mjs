...
export const HUBS = {
  "hub-1": { name: "Dublin south hub", address: "Unit 4, Newmarket, Dublin 8", location: { type: "Point", coordinates: [-6.2783, 53.3372] } },
  "hub-2": { name: "Dublin north hub", address: "Unit 9, Sheriff Street Upper, Dublin 1", location: { type: "Point", coordinates: [-6.2402, 53.3506] } },
};
